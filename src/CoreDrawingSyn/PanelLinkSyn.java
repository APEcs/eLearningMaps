 ...
 */
public class PanelLinkSyn extends javax.swing.JPanel {

  /*Variable declarations*/
  private DrawCanvasSyn canvasPanel = null;

    /** Creates new form PanelLinkSyn */
    public PanelLinkSyn(DrawCanvasSyn canvas) {
     initComponents();
  ...
  private void initComponents() {
    ...
    private void addLinkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addLinkBtnActionPerformed
     ...
     try {
      ...
      System.out.println("PanelLinkSyn");
     }//catch
